...
function MyComp({ clips }) {
  return /* @__PURE__ */ React.createElement(React.Fragment, null, clips.map((clip, index) => /* @__PURE__ */ React.createElement(
    VideoClip,
    {
      key: clip.id,
      clip,
      from: clips.slice(0, index).reduce((acc, c) => acc + c.duration, 0)
    }
  )));
}
...
const internals_js_1 = __webpack_require__(8456);
...
__exportStar(__webpack_require__(3013), exports);
var config_js_1 = __webpack_require__(3074);
...
const config_js_1 = __webpack_require__(3074);
const shared_audio_tags_js_1 = __webpack_require__(3161);
const CanUseRemotionHooks_js_1 = __webpack_require__(4144);
const CompositionManager_js_1 = __webpack_require__(4932);
...
const validate_duration_in_frames_js_1 = __webpack_require__(2363);
const validate_fps_js_1 = __webpack_require__(5868);
const validate_offthreadvideo_image_format_js_1 = __webpack_require__(2327);
const duration_state_js_1 = __webpack_require__(9099);
const volume_position_state_js_1 = __webpack_require__(1399);
...
exports.Internals = {
    ...
    Timeline,
    CompositionManager: CompositionManager_js_1.CompositionManager,
